...
- 17 EditMode tests cover the M1 surface layer: cube face basis, the 24-entry adjacency table (re-derived geometrically in the test), neighbour round-trips, node addressing and surface geometry
